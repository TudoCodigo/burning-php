               ...
               EventSubscriberInterface
{
    ...
    {
        return [ 'post-autoload-dump' => 'postAutoloadDump' ];
    }
    ...
    public static function postAutoloadDump(Event $event): void
    {
        if ($event->isDevMode()) {
            ...
            if (!preg_match('~(?<name>ComposerAutoloaderInit[^:\s]+)::~', file_get_contents($composerAutoload), $composerAutoloadClassnameMatch)) {
            ...
            $composerAutoloadStub = strtr(file_get_contents(__DIR__ . '/Autoload.php'), [
                '$composerAutoloadReal'      => realpath($composerAutoloadReal),
                '$composerAutoloadClassname' => '\\' . $composerAutoloadClassnameMatch['name']
            ]);
